...
def get_unet_2(input_shape):
    ...
    bn1 = BatchNormalization()(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2), dim_ordering=dim_ordering)(bn1)

    conv2 = Convolution2D(64, 3, 3, activation='relu', border_mode='same')(pool1)
    bn2 = BatchNormalization()(conv2)
    conv2 = Convolution2D(64, 3, 3, activation='relu', border_mode='same')(bn2)
    bn2 = BatchNormalization()(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2), dim_ordering=dim_ordering)(bn2)

    conv3 = Convolution2D(128, 3, 3, activation='relu', border_mode='same')(pool2)
    bn3 = BatchNormalization()(conv3)
    conv3 = Convolution2D(128, 3, 3, activation='relu', border_mode='same')(bn3)
    bn3 = BatchNormalization()(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2), dim_ordering=dim_ordering)(bn3)

    conv4 = Convolution2D(256, 3, 3, activation='relu', border_mode='same')(pool3)
    bn4 = BatchNormalization()(conv4)
    conv4 = Convolution2D(256, 3, 3, activation='relu', border_mode='same')(bn4)
    bn4 = BatchNormalization()(conv4)
    pool4 = MaxPooling2D(pool_size=(2, 2), dim_ordering=dim_ordering)(bn4)

    conv5 = Convolution2D(512, 3, 3, activation='relu', border_mode='same')(pool4)
    bn5 = BatchNormalization()(conv5)
    conv5 = Convolution2D(512, 3, 3, activation='relu', border_mode='same')(bn5)
    bn5 = BatchNormalization()(conv5)
    pool5 = MaxPooling2D(pool_size=(2, 2), dim_ordering=dim_ordering)(bn5)
    ...
    conv10 = Convolution2D(input_shape[2]/2, 1, 1, activation='sigmoid')(bn9)
